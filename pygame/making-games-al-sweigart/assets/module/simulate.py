...
def main():
    ...
    BEEP1 = pygame.mixer.Sound(r'..\audio\beep1.ogg')
    BEEP2 = pygame.mixer.Sound(r'..\audio\beep2.ogg')
    BEEP3 = pygame.mixer.Sound(r'..\audio\beep3.ogg')
    BEEP4 = pygame.mixer.Sound(r'..\audio\beep4.ogg')
